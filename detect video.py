...
parser.add_argument('--emb', action="store_true", default=True, help='show emb dis')
...
if __name__ == '__main__':
    ...
    vid = VideoStream("rtsp://admin:meditech123@192.168.100.90:554").start()
    ...
    milstone = None
    milstone_img = None
    milstone_masked = None
    milstone_masked_img = None
    ...
    while img_raw is not None:
        ...
        big_img = vid.read()
        ratio_X = big_img.shape[1]/480
        ratio_Y = big_img.shape[0]/270
        ...
        for b in dets:
            ...
            b = list(map(int, b))
            cv2.rectangle(big_img, (b[0], b[1]), (b[2], b[3]), color, 2)
            cx = b[0]
            cy = b[1] + 12
            cv2.putText(big_img, text, (cx, cy),
                        cv2.FONT_HERSHEY_DUPLEX, 0.5, (255, 255, 255))
            # landms
            cv2.circle(big_img, (b[6], b[7]), 1, (0, 0, 255), 4)
            cv2.circle(big_img, (b[8], b[9]), 1, (0, 255, 255), 4)
            cv2.circle(big_img, (b[10], b[11]), 1, (255, 0, 255), 4)
            cv2.circle(big_img, (b[12], b[13]), 1, (0, 255, 0), 4)
            cv2.circle(big_img, (b[14], b[15]), 1, (255, 0, 0), 4)
                # save image
